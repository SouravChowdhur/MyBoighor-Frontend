  ...
  return <>
    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50'>
      <div className='w-11/12 bg-white rounded-lg shadow-lg sm:w-1/2 lg:w-1/3'>
         <div className='flex justify-between items-center bg-orange-500 text-white px-6 py-4 rounded-t-lg'>
         ...
         <div className='flex justify-end px-6 py-4 bg-orange-500 rounded-b-lg'>
          <button className='px-4 py-2 bg-orange-100 rounded-md hover:bg-orange-200' type='button' onClick={()=>dispatch(toggleReadBookPopup())}>Close</button>
         </div>
      </div>
    </div>
