    ...
    <div className='flex flex-col justify-center md:flex-row h-screen'>
      ...
      <div className='max-w-sm w-full'>
          ...
          <form onSubmit={handleLogin}>
            <div className='mb-4'>
              <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} name="email" autoComplete="email" placeholder='Email' className='px-4 py-3 w-full border border-orange-500 rounded-md focus:outline-none'/>
            </div>
            <div className='mb-4'>
